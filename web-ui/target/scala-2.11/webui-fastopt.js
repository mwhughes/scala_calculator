...
$c_Lcalculator_Calculator$.prototype.cyclicReference$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D = (function(expr2, referenced, references$1) {
  _cyclicReference: while (true) {
    var x1 = expr2;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      if (referenced.contains__O__Z(name)) {
        ...
        var temp$expr2 = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references$1);
        var temp$referenced = $as_sci_Set(referenced.$$plus__O__sc_Set(name));
        expr2 = temp$expr2;
        referenced = temp$referenced;
        continue _cyclicReference
      }
    } else if ($is_Lcalculator_Plus(x1)) {
      var x4 = $as_Lcalculator_Plus(x1);
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.cyclicReference$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a, referenced, references$1) + this.cyclicReference$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b, referenced, references$1))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.cyclicReference$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a$2, referenced, references$1) - this.cyclicReference$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b$2, referenced, references$1))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.cyclicReference$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a$3, referenced, references$1) * this.cyclicReference$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b$3, referenced, references$1))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.cyclicReference$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a$4, referenced, references$1) / this.cyclicReference$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b$4, referenced, references$1))
    } else {
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  return this.cyclicReference$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(expr, $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())), references)
});
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2) {
    return (function() {
      var array = [(($uD($m_Lcalculator_Polynomial$().computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal(a$2, b$2, c$2).apply__O()) - $uD(b$2.apply__O())) / (2 * $uD(a$2.apply__O()))), (((-$uD($m_Lcalculator_Polynomial$().computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal(a$2, b$2, c$2).apply__O())) - $uD(b$2.apply__O())) / (2 * $uD(a$2.apply__O())))];
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  ...
  var a = new $c_Lcalculator_Signal().init___F0(expr);
  return a
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    var p = $as_T(x0$1.$$und1$f);
    var q = $as_Lcalculator_Signal(x0$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, q$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(q$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, q));
    return new $c_T2().init___O__O(p, new $c_Lcalculator_Signal().init___F0(expr))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
